...
# Utilities
source "${PWD}/scripts/service-versions-linux.sh"
...
install_mongo()
{
  ...
  wget --quiet https://fastdl.mongodb.org/linux/$MONGODB_VER.tgz
...
install_arango()
{
  ...
  export ARANGO_ARCHIVE="arangodb3-linux-$ARANGODB_VER.tar.gz"
  curl -O https://download.arangodb.com/arangodb$ARANGODB_V/Community/Linux/$ARANGO_ARCHIVE
