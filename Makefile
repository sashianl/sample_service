...
build-startup-script:
	...
	echo 'gunicorn --worker-class gevent --timeout 30 --workers 17 --bind :5000 --loglevel info $(SERVICE_CAPS)/$(SERVICE_CAPS)Server:application' >> $(SCRIPTS_DIR)/$(STARTUP_SCRIPT_NAME)
