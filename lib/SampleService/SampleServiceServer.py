...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_SampleService.propagate_data_link,
                             name='SampleService.propagate_data_link',
                             types=[dict])
        self.method_authentication['SampleService.propagate_data_link'] = 'required'  # noqa
